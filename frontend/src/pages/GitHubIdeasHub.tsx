...
const FEATURES: Feature[] = [
    {
        ...
        preview:
            'Compare "\u092a\u094d\u0930\u0940\u092e\u093f\u092f\u092e \u091a\u093e\u092f" vs "\u0915\u0921\u0915 \u091a\u093e\u092f" \u2014 see why Ka\u1e0dak wins by +28%',
    },
    {
        id: 'dialect-atlas',
        number: '02',
        ...
        preview:
            'Maharashtra \u2192 Ganesh Utsav \u00b7 WhatsApp 72% \u00b7 "Kadak, Bindaas, Aamchi"',
    },
    {
        id: 'focus-group',
        number: '03',
        ...
        accentColor: '#a855f7',
        highlights: [
            '3 typed persona voices',
            'Live voting ticker',
            'Consensus BharatScore',
            'WhatsApp UI',
        ],
        preview:
            'Ramesh: "\u0921\u093f\u0938\u094d\u0915\u093e\u0909\u0902\u091f \u0938\u093e\u092b\u093c \u0928\u0939\u0940\u0902 \u0926\u093f\u0916 \u0930\u0939\u093e!" \u00b7 Ananya: "Needs a punchy hook \ud83d\udd25"',
    },
    {
        id: 'command-palette',
        number: '04',
    ...
    },
    {
        ...
        highlights: [
            '4 voice personas',
            'Canvas waveform viz',
            'WhatsApp audio export',
            'Bilingual scripts',
        ],
        preview:
            'Mumbai RJ: "Kadak deal \u2014 sirf aaj ke liye! \ud83c\udfb5" \u2192 export as WhatsApp note',
    },
    {
        id: 'sensitivity',
        number: '06',
        ...
        highlights: [
            '6 audit categories',
            'Flagged term chips',
            'Real PR incident refs',
            'Animated pass/fail',
        ],
        preview:
            '"Chicken biryani Navratri 20% off" \u2192 \u26a0\ufe0f Religious conflict detected',
    },
    {
        id: 'poster-studio',
        number: '07',
    ...
    },
    {
        ...
        preview:
            '"Kadak deal" \u2192 "\u0915\u0921\u0915 \u0921\u0940\u0932" \u2192 "KADAK Deal \ud83d\udd25" in 0.2s',
    },
];
...
const PACKS = [
    {
        ...
        emoji: '\ud83e\udde0',
        ids: ['slang-diff', 'dialect-atlas'],
        color: '#4ade80',
    },
    {
        name: 'Multi-Agent Live Experience',
        emoji: '\ud83e\udd16',
        ids: ['focus-group', 'command-palette'],
        color: '#a855f7',
    },
    {
        name: 'Voice & Visual Creator',
        emoji: '\ud83c\udfa8',
        ids: ['audio-studio', 'poster-studio'],
        color: '#ef4444',
    },
];
...
function FeatureCard({ feature, index }: { feature: Feature; index: number }) {
    ...
    return (
        ...
        >
            ...
            {/* Highlight chips */}
            <div
                style={{ display: 'flex', gap: '0.3rem', flexWrap: 'wrap', marginBottom: '0.9rem' }}
            >
            ...
            >
                {feature.ctaAction === 'ctrl+k'
                    ? '\u2318K \u2014 Try Now'
                    : `\u2192 Launch ${feature.icon} ${feature.title.split(' ').slice(0, 3).join(' ')}`}
            </motion.button>
        </motion.div>
    );
}
    ...
    return (
        <div
            style={{
                minHeight: '100vh',
                display: 'flex',
                background: 'linear-gradient(135deg,#050c10 0%,#08100a 40%,#0a0820 100%)',
            }}
        >
            <Sidebar />
            <main
            ...
            >
                ...
                >
                    ...
                    <div style={{ maxWidth: 760 }}>
                        ...
                        >
                            Specialized, niche, and indie open-source mechanics for India's cultural
                            diversity, voice-first Tier-2/3 markets, and hyperlocal marketing
                            intelligence. Each feature is inspired by a real GitHub repository with
                            proven community traction.
                        </p>
                    </div>
                ...
                >
                    <span style={{ color: '#475569', fontSize: '0.78rem', marginRight: '0.25rem' }}>
                        Filter:
                    </span>
                    <button
                    ...
                    {PACKS.map(pack => (
                        <button
                            key={pack.name}
                            onClick={() =>
                                setActiveFilter(activeFilter === pack.name ? 'all' : pack.name)
                            }
                            style={{
                                background:
                                    activeFilter === pack.name
                                        ? `${pack.color}20`
                                        : 'rgba(255,255,255,0.04)',
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {packFeatures.map(f => (
                                        ...
                                        >
                                            ...
                                            <Link
                                                ...
                                                onMouseOver={e =>
                                                    (e.currentTarget.style.color = pack.color)
                                                }
                                                onMouseOut={e =>
                                    ...
                                    <button
                                        ...
                                        onMouseOver={e => {
                                            e.currentTarget.style.background = `${pack.color}30`;
                                        }}
                                        onMouseOut={e => {
                                            e.currentTarget.style.background = `${pack.color}20`;
                                        }}
                                    >
                                        Launch Pack {'\u2192'}
                                    </button>
                ...
                <motion.div
                    ...
                    style={{
                        marginTop: '2.5rem',
                        background:
                            'linear-gradient(135deg,rgba(148,163,184,0.07),rgba(71,85,105,0.04))',
                ...
                >
                    <div>
                        ...
                        <div style={{ color: '#64748b', fontSize: '0.82rem' }}>
                            ...
                            to open the global palette {'\u2014'} navigate, audit copy, switch
                            languages instantly
                        </div>
                    </div>
                    <motion.button
