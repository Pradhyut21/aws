                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 glass-card p-6">
                        ...
                        <div className="flex items-center justify-between mb-5">
                            <button
                                onClick={prevMonth}
                                className="w-9 h-9 rounded-xl glass-card flex items-center justify-center text-slate-400 hover:text-white transition-all"
                            >
                                ←
                            </button>
                            ...
                            <div className="glass-card p-5">
                                <h3 className="font-bold font-poppins text-white mb-3 text-sm">
                                    ...
                                    {selectedPosts.length > 0
                                        ? `${selectedPosts.length} campaign${selectedPosts.length !== 1 ? 's' : ''}`
                                        : 'No campaigns'}
                                </h3>
                                {selectedPosts.length === 0 ? (
                                    ...
                                    <div key={i} className="flex items-center gap-3 text-sm">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-slate-500 text-xs">
                                                {months[currentMonth]} {p.day} · {p.time}
                                            </p>
                                        </div>
                                    </div>
                                ))}
