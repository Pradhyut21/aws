...
const AUDIT_CHECKS: AuditCheck[] = [
    {
        ...
        passMessage:
            'No religious dietary conflicts detected. Safe for Navratri, Shravan & Ramzan seasons.',
        failMessage:
            'Potential dietary/festive conflict detected. Avoid during Navratri, Shravan, Jain Paryushan or Ramzan periods.',
        severity: 'critical',
    },
    {
        id: 'linguistic',
        ...
        failMessage:
            'Detected words that may carry offensive double meanings in other regional dialects.',
        severity: 'critical',
    },
    {
        id: 'color',
        ...
        failMessage:
            'Copy references colors/symbols associated with mourning in Indian culture. Review before festive campaigns.',
        severity: 'warning',
    },
    {
        id: 'asci',
        ...
        passMessage:
            'No unsubstantiated superlative claims detected. Compliant with ASCI guidelines.',
        failMessage:
            'Detected potentially unsubstantiated claims. ASCI guidelines require proof for superlatives like "best", "guaranteed", or "clinically proven".',
        severity: 'warning',
    },
    {
        id: 'gender',
        ...
        failMessage:
            'Detected colorism or gender-stereotyping language. This may trigger social media backlash.',
        severity: 'critical',
    },
    {
        id: 'taboo',
        ...
        failMessage:
            'Detected words flagged as taboo in specific regional dialects. Review with native speaker before publishing.',
        severity: 'warning',
    },
];
    ...
    return (
        ...
        >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                    <span style={{ color: '#e2e8f0', fontWeight: 700, fontSize: '0.875rem' }}>
                        {check.label}
                    </span>
                    <span
                        style={{
    ...
    return (
        ...
        >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ color: '#64748b', fontSize: '0.75rem', marginBottom: '0.4rem' }}>
                    Amazon Rekognition scans uploaded images for explicit, violent, or culturally
                    offensive content
                </div>
                <AnimatePresence>
                    {result.status !== 'idle' && result.status !== 'running' && (
...
const SAMPLES = [
    {
        label: 'Safe Campaign ✅',
        text: 'Celebrate Ganesh Utsav with our festive sweets collection! 🎊 Pure vegetarian, home-made mithai. Order now for same-day delivery across Maharashtra.',
    },
    {
        label: 'Risky — Dietary ⚠️',
        text: 'Navratri special! Enjoy our chicken biryani with 20% off. Guaranteed best taste. Non-veg lovers unite! Free home delivery.',
    },
    {
        label: 'Risky — Claims ⚠️',
        text: "India's #1 fairness cream — clinically proven to give gori skin in 7 days! 100% guaranteed results. Best product in the world for fair complexion.",
    },
];
    ...
    return (
        <div
            style={{
                minHeight: '100vh',
                display: 'flex',
                background: 'linear-gradient(135deg,#08100a 0%,#0a0820 50%,#0a0808 100%)',
            }}
        >
            <Sidebar />
            <main
            ...
            >
                ...
                >
                    ...
                    <p style={{ color: '#64748b', margin: '0.25rem 0 0', fontSize: '0.9rem' }}>
                        7-point safety audit — text checks + Amazon Rekognition image moderation.
                        Protect your brand from costly PR disasters.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        ...
                        >
                            ...
                            >
                                {running
                                    ? '🔍 Running Cultural Audit…'
                                    : '🛡️ Run Text Sensitivity Audit'}
                            </motion.button>
                        </motion.div>
                        ...
                        >
                            ...
                            >
                                Upload your campaign image to scan for explicit, violent, or
                                culturally offensive content using AWS AI.
                            </p>
                            ...
                            <motion.button
                                ...
                                style={{
                                    width: '100%',
                                    background: imageRunning
                                        ? 'rgba(255,255,255,0.04)'
                                        : 'rgba(255,153,0,0.12)',
                                    border: '1px solid rgba(255,153,0,0.3)',
                                    borderRadius: '0.75rem',
                                    padding: '0.65rem',
                                    color: imageRunning ? '#475569' : '#FF9900',
                                    fontWeight: 700,
                                    fontSize: '0.85rem',
                        ...
                        <AnimatePresence>
                            {done && (
                                ...
                                >
                                    ...
                                    <div
                                        style={{
                                            color: overallSafe ? '#4ade80' : '#f87171',
                                            fontWeight: 800,
                                            fontSize: '1.1rem',
                                        }}
                                    >
                                    ...
                                    >
                                        {passCount}/{totalChecks} checks passed · {failCount}{' '}
                                        {failCount === 1 ? 'issue' : 'issues'} found
                                    </div>
                                    <div
                                        style={{
                                            display: 'flex',
                                    ...
                                    {!overallSafe && (
                                        ...
                                        >
                                            Fix the flagged items above before publishing to avoid
                        ...
                        >
                            ...
                            {[
                                {
                                    icon: '📉',
                                    text: 'Zomato faced backlash for a Navratri ad featuring meat. Stock dropped 3% in 2 hours.',
                                },
                                {
                                    icon: '🚫',
                                    text: 'A Tamil Nadu brand used a word harmless in Hindi that was vulgar in Tamil — viral for wrong reasons.',
                                },
                                {
                                    icon: '💸',
                                    text: 'ASCI received 800+ complaints against brands in 2023 for false superlative claims.',
                                },
                                {
                                    icon: '🖼️',
                                    text: 'Amazon Rekognition can detect explicit, violent, or hate-symbol content in campaign images before they go live.',
                                },
                            ].map((item, i) => (
                                <div
                                    key={i}
