...
export default function Dashboard() {
    ...
    const stateCount = new Set(campaigns.flatMap((c: { regions: string[] }) => c.regions || []))
        .size;
            ...
            <main className="flex-1 ml-[220px] p-8">
                ...
                >
                    <div>
                        ...
                        <p className="text-slate-400 mt-1">
                            {total > 0
                                ? `${total} campaign${total !== 1 ? 's' : ''} created — keep growing!`
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2">
                        <h2 className="font-bold font-poppins text-white text-lg mb-4">
                            Recent Campaigns
                        </h2>
                        {campaigns.length === 0 ? (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="font-semibold text-white text-sm truncate">
                                                    {c.input?.slice(0, 50) || c.businessType}
                                                </p>
                                                <p className="text-slate-400 text-xs">
                                                    {c.businessType} ·{' '}
                                                    {(c.regions || []).join(', ') || 'India'} ·{' '}
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="glass-card p-5">
                            <h3 className="font-bold font-poppins text-white mb-4 text-sm">
                            ...
                            <div className="space-y-3">
                                {MOCK_ANALYTICS.platformBreakdown.map(p => {
                                    ...
                                    const maxReach = Math.max(
                                        ...MOCK_ANALYTICS.platformBreakdown.map(x => x.reach)
                                    );
                                    return (
                                        <div key={p.platform}>
                    ...
                    <div className="flex items-center justify-between mb-5">
                        <div>
                            <div className="flex items-center gap-3 mb-1">
                                <h2 className="font-bold font-poppins text-white text-lg">
                                    🇮🇳 Innovative Bharat Tools
                                </h2>
                                <span
                                    style={{
                                        background:
                            ...
                            <p className="text-slate-500 text-xs">
                                Specialized tools for India's cultural diversity, voice-first
                                markets & regional intelligence
                            </p>
                        </div>
                        <Link
                            to="/dialect-atlas"
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        {[
                            ...
                            },
                            {
                                ...
                                path: '/cultural-diff',
                                gradient:
                                    'linear-gradient(135deg,rgba(74,222,128,0.15),rgba(34,211,238,0.08))',
                            ...
                            {
                                icon: '🛡️',
                                label: 'Sensitivity Guard',
                                sub: '6-point cultural safety audit',
                                path: '/sensitivity',
                                gradient:
                                    'linear-gradient(135deg,rgba(251,191,36,0.15),rgba(248,113,113,0.08))',
                            ...
                            },
                            {
                                ...
                                path: '/audio-studio',
                                gradient:
                                    'linear-gradient(135deg,rgba(239,68,68,0.15),rgba(249,115,22,0.08))',
                            ...
                            },
                            {
                                ...
                                path: '/poster-studio',
                                gradient:
                                    'linear-gradient(135deg,rgba(217,70,239,0.15),rgba(168,85,247,0.08))',
                            ...
                            },
                            {
                                ...
                                gradient:
                                    'linear-gradient(135deg,rgba(34,211,238,0.15),rgba(99,102,241,0.08))',
                            ...
                            },
                            {
                                ...
                                path: '/dashboard',
                                gradient:
                                    'linear-gradient(135deg,rgba(148,163,184,0.1),rgba(71,85,105,0.08))',
