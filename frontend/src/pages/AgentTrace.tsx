...
export default function AgentTrace({ campaignId: propCampaignId }: { campaignId?: string }) {
    ...
    useEffect(() => {
        if (resolvedId) fetchTrace(resolvedId);
    }, [resolvedId, fetchTrace]);
    ...
    return (
        <div
            ...
            style={{ background: 'linear-gradient(135deg,#070c18 0%,#0f0c1f 50%,#071218 100%)' }}
        >
            <Sidebar />
            <main className="flex-1 ml-[220px] p-8 max-w-5xl">
                ...
                >
                    ...
                    <p className="text-slate-400 text-sm">
                        Every AI decision — tool name, input, output, latency — stored in DynamoDB
                        per campaign.
                    </p>
                </motion.div>
                ...
                {loading && (
                    ...
                    >
                        ...
                        <span className="font-mono text-sm">
                            Loading agent trace from DynamoDB…
                        </span>
                    </motion.div>
                )}
                    ...
                    <>
                        ...
                        >
                            {[
                                ...
                                {
                                    label: 'FAILED',
                                    value: trace.length - successCount,
                                    color: '#f87171',
                                },
                                {
                                    label: 'TOTAL LATENCY',
                        ...
                        <div className="relative">
                            ...
                            <div
                                ...
                                style={{
                                    background:
                                        'linear-gradient(to bottom, rgba(167,139,250,0.4), rgba(167,139,250,0.05))',
                                }}
                            />
                                    ...
                                    {visibleTrace.map((step, i) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {/* Step dot */}
                                                <div
                                                    className="absolute left-0 top-4 flex items-center justify-center w-[46px] h-[46px]"
                                                    style={{ zIndex: 1 }}
                                                >
                                                    <motion.div
                                                        animate={
                                                        ...
                                                        {isExpanded && (
                                                            ...
                                                            >
                                                                <div className="mt-4 pt-4 border-t border-white/6 grid grid-cols-1 lg:grid-cols-2 gap-4">
                                                                    <div>
                                                                        <p className="text-[11px] font-mono font-semibold text-slate-500 mb-1.5 uppercase tracking-wider">
                                                                            Input
                                                                        </p>
                                                                        <pre
                                                                            className="text-xs text-slate-300 rounded-lg p-3 overflow-auto max-h-36 font-mono leading-relaxed"
                                                                            style={{
                                                                                background:
                                                                                    'rgba(0,0,0,0.3)',
                                                                    ...
                                                                    {step.error && (
                                                                        <div
                                                                            className="lg:col-span-2 rounded-lg p-3 text-xs font-mono text-red-300"
                                                                            style={{
                                                                                background:
                ...
                {!loading && trace.length === 0 && !error && (
                    ...
                    >
                        ...
                        <p className="text-slate-500 text-sm max-w-sm">
                            Enter a Campaign ID above to view the full AI agent decision trace from
                            DynamoDB. Each step shows tool name, input, output and latency.
                        </p>
                    </motion.div>
                )}
            </main>
