            ...
            >
                ...
                <div>
                    ...
                    <p style={{ color: '#64748b', margin: '0.25rem 0 0', fontSize: '0.9rem' }}>
                        Live signals (demo stream) + campaign lessons extracted by the AI and stored
                        in DynamoDB.
                    </p>
                </div>
            </div>
                ...
                <div style={{ maxWidth: '800px' }}>
                    ...
                    >
                        ...
                        <p style={{ color: '#fbbf24', fontSize: '0.8rem', margin: 0 }}>
                            <strong>SIMULATED DATA</strong> — These signals are for demonstration.
                            In production, connect to a real social listening API (e.g., Twitter
                            API, Meta Business, or Google Trends) via Kinesis → Lambda → Bedrock.
                        </p>
                    </div>
                ...
                <div style={{ maxWidth: '800px' }}>
                    {lessons.length === 0 ? (
                        ...
                        >
                            ...
                            <p style={{ margin: 0 }}>
                                No lessons yet. Run a campaign — the AI will extract a lesson and
                                store it here automatically.
                            </p>
                        </div>
                    ) : (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            {lessons.map((l: any) => (
                                ...
                                >
                                    ...
                                    >
                                        <strong style={{ color: '#cbd5e1' }}>Strategy:</strong>{' '}
                                        {l.strategy}
                                    </div>
                                    <div
                                        style={{
                                    ...
                                    >
                                        {new Date(l.createdAt).toLocaleString('en-IN')} · Campaign{' '}
