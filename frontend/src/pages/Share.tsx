...
function QRPlaceholder({ value }: { value: string }) {
    return (
        <div
            className="w-28 h-28 rounded-xl flex items-center justify-center text-center p-2"
            style={{ background: '#fff' }}
        >
            <div className="text-[8px] leading-tight text-slate-800 font-mono break-all opacity-60">
                {value.slice(0, 60)}
            </div>
        </div>
    );
...
export default function Share() {
    ...
    return (
        <div
            ...
            style={{ background: 'linear-gradient(135deg, #0A0F1E 0%, #0D1B40 100%)' }}
        >
            {/* Header */}
            <div className="flex items-center gap-3 px-6 py-4 border-b border-white/5">
                ...
                <Link to="/campaign/new" className="btn-primary py-1.5 px-4 text-xs">
                    Create Yours →
                </Link>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-6 py-10">
                ...
                >
                    ...
                    <h1 className="text-4xl font-black font-poppins gradient-text mb-2">
                        Varanasi Silk Sarees
                    </h1>
                    <p className="text-slate-400">
                        Diwali Campaign · Hindi · Generated with Amazon Bedrock Nova Pro
                    </p>
                    ...
                    <div className="inline-flex items-center gap-3 mt-4 px-5 py-2.5 rounded-xl glass-card">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-slate-500 text-xs">
                                Culturally optimized · Passed all guardrails
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    {(campaign.content?.images || [])
                        .slice(0, 2)
                        .map((img: { id: string; url: string; platform: string }, i: number) => (
                            <motion.div
                                key={img.id}
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {Object.entries(campaign.content?.captions || {})
                            .slice(0, 4)
                            .map(([platform, caption]) => (
                                ...
                                >
                                    ...
                                    <p className="text-slate-400 text-xs line-clamp-3 whitespace-pre-line">
                                        {String(caption)}
                                    </p>
                                </div>
                            ))}
                ...
                >
                    <h2 className="font-bold font-poppins text-white mb-1">
                        🔗 Share this Campaign
                    </h2>
                    <p className="text-slate-400 text-sm mb-5">
                        Send this link to clients, investors, or your team
                    </p>
                    ...
                    <div className="flex items-center gap-3 justify-center mb-5">
                        ...
                        <div className="text-left">
                            ...
                            <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-white/10 bg-white/4">
                                <span className="text-xs font-mono text-slate-300 truncate max-w-40">
                                    {shareUrl}
                                </span>
                            </div>
                            <button
                                onClick={copyLink}
                                className="mt-2 text-orange-400 text-xs hover:text-orange-300 transition-colors"
                            >
                                📋 Copy Link
                            </button>
                        </div>
                ...
                <div className="text-center mt-10">
                    <p className="text-slate-400 mb-4">
                        Want campaigns like this for your business?
                    </p>
                    <Link
                        to="/campaign/new"
                        className="btn-primary text-base py-3 px-8 inline-block"
                    >
