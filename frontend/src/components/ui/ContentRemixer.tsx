...
const REMIX_TONES: RemixTone[] = [
    {
        ...
        label: 'Festival Mode',
        color: '#F7C948',
        sampleSuffix: '🎆 Diwali Special! Great deals this festive season. Hurry!',
    },
    {
        id: 'urgent',
        emoji: '⚡',
        label: 'Urgent Sale',
        color: '#FF4444',
        sampleSuffix: "⚡ LAST 24 HOURS! Don't miss this deal — stock is running out!",
    },
    {
        id: 'premium',
        emoji: '👑',
        label: 'Premium Feel',
        color: '#9B5DE5',
        sampleSuffix: '👑 Exclusive collection for those who appreciate the finest.',
    },
    {
        id: 'friendly',
        emoji: '🤝',
        ...
        color: '#00FF88',
        sampleSuffix: '🙏 Namaskar friends! Come visit us — like family, always!',
    },
    {
        id: 'viral',
        emoji: '🔥',
        label: 'Viral/Trendy',
        color: '#FF6B35',
        sampleSuffix: "🔥 Everyone's talking about it! See why → limited stock!",
    },
    {
        id: 'trust',
        emoji: '🛡️',
        label: 'Trust Builder',
        color: '#00D4FF',
        sampleSuffix: '✅ 10 years in business · 5000+ happy customers · 100% genuine.',
    },
];
...
export default function ContentRemixer({ originalCaption, platform }: ContentRemixerProps) {
    ...
    const copyRemixed = () => {
        ...
        toast.success('Remixed caption copied! 🔄');
    };
    ...
    return (
        <div className="glass-card p-5 border-purple-500/20">
            ...
            <p className="text-slate-400 text-xs mb-4">
                Re-tone your {platform} caption for different occasions
            </p>
            ...
            <AnimatePresence>
                ...
                {remixedText && !loading && (
                    ...
                    >
                        <p className="text-slate-200 text-sm whitespace-pre-line leading-relaxed mb-3">
                            {remixedText}
                        </p>
                        <button
                            onClick={copyRemixed}
