    ...
    const Slider = ({
        ...
        <div className="mb-4">
            ...
            <input
                ...
                style={{
                    background: `linear-gradient(90deg, #FF6B35 ${((value - min) / (max - min)) * 100}%, rgba(255,255,255,0.1) 0%)`,
                }}
            />
        </div>
    );
        ...
        <div className="glass-card p-6">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
                {[
                    ...
                    >
                        <p
                            className="font-black font-poppins text-lg"
            ...
            >
                <p className="text-slate-400 text-xs mb-1">
                    Campaign cost: <strong className="text-white">₹{campaignCost}</strong>
                </p>
                <p className="text-2xl font-black font-poppins text-green-400">
