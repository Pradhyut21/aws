                            ...
                            >
                                ...
                                <div className="flex items-center gap-4">
                                    <img
                                        src={user.avatar}
                                        alt="Avatar"
                                        className="w-16 h-16 rounded-full border border-white/10 bg-slate-800"
                                    />
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 bg-slate-900/50 border border-slate-700/50 rounded-lg text-white focus:outline-none focus:border-orange-500/50 text-sm"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1.5">
                                        ...
                                        <input
                                            ...
                                            disabled
                                            className="w-full px-3 py-2 bg-slate-900/50 border border-slate-700/50 rounded-lg text-slate-400 text-sm opacity-70 cursor-not-allowed"
                                        />
                        ...
                        {activeTab === 'billing' && (
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm text-slate-400">
                                        View your active plan and payment history.
                                    </p>
                                </div>
                                ...
                                <div className="p-4 rounded-xl border border-orange-500/20 bg-orange-500/5 flex flex-col gap-3">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <div className="inline-flex items-center gap-2 mb-1">
                                                <span className="text-orange-400 font-bold font-poppins">
                                                    Pro Plan
                                                </span>
                                            ...
                                            <p className="text-xs text-slate-400">
                                                Renews on Mar 26, 2026 for ₹99/mo.
                                            </p>
                                        </div>
                                    ...
                                    <p className="text-[10px] text-slate-400 text-right">
                                        3 of 20 days remaining in trial
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center justify-between p-3 rounded-lg border border-white/10 bg-white/5">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-6 bg-slate-800 rounded shadow flex items-center justify-center text-[10px] font-bold text-white border border-white/20">
                                                VISA
                                            </div>
                                        ...
                                        <button className="text-xs text-slate-400 hover:text-white transition-colors focus:outline-none">
                                            Update
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-center py-6 px-4 border border-white/5 border-dashed rounded-lg">
                                        <p className="text-slate-500 text-xs">
                                            No invoices yet. You are currently on a free trial.
                                        </p>
                                    </div>
                                </div>
                            </motion.div>
