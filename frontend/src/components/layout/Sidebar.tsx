...
const NAV_SECTIONS: { label: string; items: { path: string; icon: string; label: string; shortcut?: string }[] }[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/market-pulse', icon: '📡', label: 'Market Pulse', shortcut: 'M' },
            { path: '/experiments', icon: '⚗️', label: 'Experiment Lab', shortcut: 'E' },
        ],
    },
    {
        label: 'AI Features',
        items: [
            { path: '/brain', icon: '🧠', label: 'BharatBrain', shortcut: 'B' },
            { path: '/trace', icon: '🔍', label: 'Agent Trace' },
            { path: '/focus-group', icon: '💬', label: 'Focus Group', shortcut: 'F' },
            { path: '/dialect-atlas', icon: '🗺️', label: 'Dialect Atlas' },
        ],
    },
    {
        label: 'Cultural Tools',
        items: [
            { path: '/cultural-diff', icon: '✨', label: 'Slang Diff' },
            { path: '/sensitivity', icon: '🛡️', label: 'Sensitivity' },
            { path: '/transliteration', icon: '⌨️', label: 'Transliterate' },
        ],
    },
    {
        label: 'Creator Studio',
        items: [
            { path: '/audio-studio', icon: '🎙️', label: 'Voice Studio' },
            { path: '/poster-studio', icon: '🎨', label: 'Poster Studio', shortcut: 'P' },
        ],
    },
    {
        label: 'Innovation',
