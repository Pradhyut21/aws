        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <Link to="/" className="flex items-center gap-3">
                    ...
                    <div>
                        <span className="font-black font-poppins text-lg gradient-text">
                            BharatMedia
                        </span>
                        <div className="text-[9px] text-slate-500 font-mono -mt-1 tracking-wider">
            ...
            {menuOpen && (
                ...
                >
                    <Link
                        to="/dashboard"
                        className="text-slate-300 py-2 border-b border-white/10"
