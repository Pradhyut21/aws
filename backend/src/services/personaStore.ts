...
export const INDIAN_PERSONAS: IndianPersona[] = [
    {
        personaId: 'P01',
        name: 'Young Bengaluru Tech Worker',
        age: 26,
        gender: 'M',
        state: 'Karnataka',
        city: 'Bengaluru',
    ...
    },
    {
        ...
        culturalTriggers: [
            ...
            'trust and quality',
            'Hindi messaging',
            'local brand endorsements',
        ],
        culturalTaboos: [
            'immodest imagery',
            'English-only content',
            'aspirational messaging that feels out of reach',
        ],
    ...
    },
    {
        ...
        culturalTaboos: [
            'city-centric messaging',
            'ignoring rural context',
    ...
    {
        personaId: 'P04',
        name: 'Tamil Nadu College Student',
        age: 20,
        gender: 'F',
        state: 'Tamil Nadu',
        city: 'Chennai',
        ...
        culturalTaboos: [
            'Bollywood-heavy references',
            'ignoring Dravidian culture',
            'Hindi imposition',
        ],
    ...
    {
        personaId: 'P06',
        name: 'Hyderabad IT Professional',
        age: 29,
        gender: 'F',
        state: 'Telangana',
        city: 'Hyderabad',
        ...
        culturalTriggers: [
            'career growth',
            'Hyderabad tech scene',
            'Telugu identity',
            'modern lifestyle',
        ],
        culturalTaboos: [
            'gender stereotyping',
            'Andhra/Telangana conflation',
            'outdated women roles',
        ],
    ...
    {
        personaId: 'P07',
        name: 'West Bengal Retired Officer',
        age: 62,
        gender: 'M',
        state: 'West Bengal',
        city: 'Kolkata',
    ...
    {
        personaId: 'P08',
        name: 'Delhi Delivery Gig Worker',
        age: 24,
        gender: 'M',
        state: 'Delhi NCR',
        city: 'Delhi',
        ...
        culturalTriggers: [
            'aspiration and hustle',
            'value for money',
            'offers and discounts',
            'gig economy solidarity',
        ],
    ...
    {
        personaId: 'P09',
        name: 'Mumbai Fashion-Conscious Woman',
        age: 31,
        gender: 'F',
        state: 'Maharashtra',
        city: 'Mumbai',
    ...
    {
        personaId: 'P10',
        name: 'Rajasthan First-Gen Smartphone User',
        age: 48,
        gender: 'F',
        state: 'Rajasthan',
        city: 'Jaipur (peri-urban)',
        language: 'Hindi (Rajasthani dialect)',
        income: '₹1.5L/yr',
        occupation: 'Street vendor (handicrafts)',
        ...
        culturalTaboos: [
            ...
            'urban-only framing',
            'ignoring rural artisanal value',
        ],
    ...
    },
    {
        ...
        culturalTaboos: [
            'mainland-centric messaging',
            'ignoring Northeast identity',
            'fast-food lifestyle',
        ],
    ...
    {
        personaId: 'P13',
        name: 'Pune College Entrepreneur',
        age: 22,
        gender: 'M',
        state: 'Maharashtra',
        city: 'Pune',
    ...
    {
        personaId: 'P14',
        name: 'Odisha Tribal Artisan',
        age: 45,
        gender: 'F',
        state: 'Odisha',
        city: 'Koraput (tribal belt)',
        language: 'Odia',
        income: '₹0.8L/yr',
        occupation: 'Traditional Pattachitra artist',
        platform: ['WhatsApp'],
        deviceType: 'smartphone-budget',
        ...
        culturalTaboos: [
            'urban lifestyle imposition',
            'ignoring tribal identity',
            'luxury framing',
        ],
    ...
    {
        personaId: 'P15',
        name: 'Chandigarh Young Parent',
        age: 33,
        gender: 'F',
        state: 'Punjab/Haryana',
        city: 'Chandigarh',
        language: 'Hindi/Punjabi',
        income: '₹8-12L/yr (dual income)',
        ...
        culturalTaboos: [
            ...
            'unhealthy product glorification',
        ],
    ...
    {
        personaId: 'P16',
        name: 'Chennai Auto Rickshaw Driver',
        age: 50,
        gender: 'M',
        state: 'Tamil Nadu',
        city: 'Chennai',
    ...
    },
    {
        ...
        language: 'Malayalam',
        secondaryLanguage: 'English',
        income: '₹0.8L/yr (content creator)',
        occupation: 'Student + influencer (12K followers)',
        platform: ['Instagram', 'YouTube', 'Moj'],
        deviceType: 'smartphone-premium',
    ...
    {
        personaId: 'P18',
        name: 'Jaipur Senior Woman',
        age: 68,
        gender: 'F',
        state: 'Rajasthan',
        city: 'Jaipur',
        language: 'Hindi',
        income: '₹3L/yr (joint family)',
    ...
    {
        personaId: 'P19',
        name: 'Bengaluru Muslim Professional',
        age: 32,
        gender: 'M',
        state: 'Karnataka',
        city: 'Bengaluru',
        ...
        culturalTriggers: [
            'halal certification relevance',
            'inclusive multicultural India',
            'professional identity',
        ],
        culturalTaboos: [
            'Hindu-only festival assumptions',
            'Islamophobic undertones',
            'pork or alcohol adjacent content',
        ],
    ...
    },
    {
        ...
        income: '₹1.5L/yr',
        occupation: 'NGO field worker',
        platform: ['Facebook', 'Instagram', 'YouTube'],
        deviceType: 'smartphone-budget',
        festivalSensitivity: ['Hornbill Festival', 'Christmas'],
        culturalTriggers: [
            'Northeast pride',
            'tribal identity recognition',
            'English content (preferred over Hindi)',
            'community development',
        ],
        culturalTaboos: [
            'Hindi-only messaging',
            'mainland-centric jokes',
            'racial appearance comments',
        ],
...
export async function seedPersonas(): Promise<void> {
    ...
    try {
        ...
        console.warn(
            '⚠️  Could not seed personas to DynamoDB (using in-memory fallback):',
            err.message
        );
