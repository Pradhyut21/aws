...
export async function createTableIfNotExists(): Promise<void> {
    try {
        ...
        console.log(
            `✅ DynamoDB table '${TABLE_NAME}' created with UserCampaignsIndex, PublicTemplatesIndex, EmailIndex.`
        );
    }
}
...
export const campaigns = {
    ...
    set: async (_id: string, _campaign: Campaign) => {
        /* no-op — use updateCampaign */
    },
};
